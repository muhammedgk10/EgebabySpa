        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
              Ege<span className="text-brand">BabySpa</span> <span className="text-xs font-normal text-gray-400 mt-2">Şanlıurfa</span>
            </h3>
            ...
            <div className="mb-6">
                <h4 className="text-xs font-bold text-brand uppercase tracking-wider mb-2">Hizmet Bölgelerimiz</h4>
                <div className="flex flex-wrap gap-2 text-xs text-gray-500">
                    <span className="hover:text-white transition-colors">Şanlıurfa Merkez</span> •
                    <span className="hover:text-white transition-colors">Haliliye Bebek Spa</span> •
                    <span className="hover:text-white transition-colors">Karaköprü Bebek Masajı</span> •
                    <span className="hover:text-white transition-colors">Eyyübiye</span> •
                    <span className="hover:text-white transition-colors">Bahçelievler</span> • 
                    <span className="hover:text-white transition-colors">Yenişehir</span>
                </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><button onClick={() => scrollTo(SectionId.PACKAGES)} className="text-gray-400 hover:text-brand transition-colors">Fiyatlar</button></li>
              ...
              <li><button onClick={() => scrollTo(SectionId.BLOG)} className="text-gray-400 hover:text-brand transition-colors">Blog & Rehber</button></li>
          ...
          <div>
             ...
             <div className="space-y-3 text-sm text-gray-400">
               <div className="flex items-start gap-3">
                 ...
                 <span>Bahçelievler Mah. Atatürk Bulv.<br/>Haliliye / Şanlıurfa (Novada Yanı)</span>
               </div>
